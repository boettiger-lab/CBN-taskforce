                ...
                with st.chat_message("assistant"):
                    with st.spinner("Invoking query..."):
                        ...
                        minio_logger(log_queries, prompt, sql_query, llm_explanation, llm_choice,
                                     ...
                                     prefix="ca-30x30-cbn-logs/query_log")
                        ...
                        for x in llm_cols:
                            ...
                            if group_by:
                                ...
                                if st.session_state.get("color") != group_by_name:
        ...
        with stats_col:
            with st.container():
                ...
                if any_chart_toggled or show_stacked or show_chatbot_chart or (column not in ['status','gap_code']):
                    option_map = {'percent_network': "Composition", 'percent_feature': "Representation",'acres': "Acres", }
